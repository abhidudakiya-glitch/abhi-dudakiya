...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (menuToggle && navLinks) {
        const iconBars = menuToggle.querySelector('.menu-icon-bars');
        const iconClose = menuToggle.querySelector('.menu-icon-close');

        const updateMenuIcon = (isActive) => {
            if (iconBars && iconClose) {
                iconBars.style.display = isActive ? 'none' : 'block';
                iconClose.style.display = isActive ? 'block' : 'none';
            }
        };

        // Explicitly initialize menu icon visibility to fix mobile browser rendering bugs
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            .then(response => {
                if (!response.ok) {
                    throw new Error('Network response was not ok. Please ensure your Web3Forms access key is valid.');
                }
    ...
    if (domeRoot) {
        ...
        const imagesPool = [
            ...
            'images/For Portfolio/compressed/04.jpg',
            'images/For Portfolio/compressed/05.jpg',
            'images/For Portfolio/compressed/06.jpg',
            
            'images/For Portfolio/compressed/08.jpg',
            'images/For Portfolio/compressed/09.jpg',
            'images/For Portfolio/compressed/10.jpg',
            'images/For Portfolio/compressed/11.jpg',
            'images/For Portfolio/compressed/12.jpg',
            'images/For Portfolio/compressed/13.jpg',
            'images/For Portfolio/compressed/14.jpg',
            'images/For Portfolio/compressed/15.jpg',
            'images/For Portfolio/compressed/16.jpg',
            'images/For Portfolio/compressed/17.jpg',
            'images/For Portfolio/compressed/18.jpg',
            'images/For Portfolio/compressed/19.jpg',
            'images/For Portfolio/compressed/20.jpg',
            'images/For Portfolio/compressed/21.jpg',
            'images/For Portfolio/compressed/22.jpg',
            'images/For Portfolio/compressed/23.jpg',
            'images/For Portfolio/compressed/24.jpg',
            'images/For Portfolio/compressed/25.jpg',
            'images/For Portfolio/compressed/26.jpg',
            'images/For Portfolio/compressed/27.jpg',
            'images/For Portfolio/compressed/28.jpg',
            'images/For Portfolio/compressed/29.jpg',
            'images/For Portfolio/compressed/30.jpg',
            'images/For Portfolio/compressed/31.jpg',
            'images/For Portfolio/compressed/32.jpg',
            'images/For Portfolio/compressed/33.jpg',
            'images/For Portfolio/compressed/34.jpg',
            'images/For Portfolio/compressed/35.jpg',
            'images/For Portfolio/compressed/36.jpg',
            'images/For Portfolio/compressed/37.jpg',
            'images/For Portfolio/compressed/38.jpg',
            'images/For Portfolio/compressed/39.jpg',
            'images/For Portfolio/compressed/40.jpg',
            'images/For Portfolio/compressed/41.jpg',
            'images/For Portfolio/compressed/42.jpg',
            'images/For Portfolio/compressed/43.jpg',
            'images/For Portfolio/compressed/44.jpg',
            'images/For Portfolio/compressed/45.jpg',
            'images/For Portfolio/compressed/46.jpg',
            'images/For Portfolio/compressed/47.jpg'
    ...
    if (track) {
        ...
        if (list) {
            ...
            track.addEventListener('pointerenter', (e) => {
                if (e.pointerType === 'mouse') targetVelocity = 0;
            });
            track.addEventListener('pointerleave', (e) => {
                if (e.pointerType === 'mouse') targetVelocity = speed;
            });
            
            // For mobile, pause while touching but resume immediately after
            track.addEventListener('touchstart', () => targetVelocity = 0, { passive: true });
            track.addEventListener('touchend', () => targetVelocity = speed, { passive: true });
            track.addEventListener('touchcancel', () => targetVelocity = speed, { passive: true });
            
            const animate = (time) => {
                if (lastTime === null) lastTime = time;
                // Cap dt at 0.1 to prevent large visual jumps after scrolling or tab switching
