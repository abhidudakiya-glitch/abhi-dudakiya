...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (domeRoot) {
        ...
        const fullResPool = [
            'images/For Portfolio/01 (2).jpg',
            'images/For Portfolio/01 TRUE3681.jpg',
            'images/For Portfolio/01.jpg',
            'images/For Portfolio/02.jpg',
            'images/For Portfolio/03 (2).JPG',
            'images/For Portfolio/03 TRUE3684.jpg',
            'images/For Portfolio/03.jpg',
            'images/For Portfolio/32.JPG',
            'images/For Portfolio/701.JPG',
            'images/For Portfolio/702.JPG',
            'images/For Portfolio/703.JPG',
            'images/For Portfolio/704.JPG',
            'images/For Portfolio/CH-01.JPG',
            'images/For Portfolio/CH-04.JPG',
            'images/For Portfolio/Design 1.png',
            'images/For Portfolio/Design 2.png',
            'images/For Portfolio/Design 3.png',
            'images/For Portfolio/GD-08.JPG',
            'images/For Portfolio/GD-17.JPG',
            'images/For Portfolio/Jewellery (1).JPG',
            'images/For Portfolio/Jewellery (2).JPG',
            'images/For Portfolio/Jewellery (3).JPG',
            'images/For Portfolio/Jewellery (4).JPG',
            'images/For Portfolio/PT - 001-a.JPG',
            'images/For Portfolio/PT - 001.JPG',
            'images/For Portfolio/PT - 007-a.JPG',
            'images/For Portfolio/PT - 007.JPG',
            'images/For Portfolio/PT - 008-a.JPG',
            'images/For Portfolio/PT - 008.JPG',
            'images/For Portfolio/PT - 009-a.JPG',
            'images/For Portfolio/PT - 009.JPG',
            'images/For Portfolio/TRUE0460.JPG',
            'images/For Portfolio/TRUE0464.JPG',
            'images/For Portfolio/TRUE0928.jpg',
            'images/For Portfolio/TRUE0930.jpg',
            'images/For Portfolio/TRUE0940.jpg',
            'images/For Portfolio/TRUE2523.JPG',
            'images/For Portfolio/TRUE2541.JPG',
            'images/For Portfolio/TRUE3708.jpg',
            'images/For Portfolio/TRUE4189.JPG',
            'images/For Portfolio/TRUE4200.JPG',
            'images/For Portfolio/TRUE4251.JPG',
            'images/For Portfolio/TRUE4253.JPG',
            'images/For Portfolio/TRUE4283.JPG',
            'images/For Portfolio/TRUE9206.JPG',
            'images/For Portfolio/TRUE9234.JPG',
            'images/For Portfolio/pikaso_edit (1).jpg'
        ];
